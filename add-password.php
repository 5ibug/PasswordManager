...
<li><a href="./logout.php"><i class="fa fa-sign-out fa-fw"></i> 注销</a>
		...
		<div id="page-wrapper">
		  <div class="header"> 
            ...
            <div id="page-inner">
            <form class="col s12" tautocomplete="off" name="form1" action='check-password.php' method='post'>
			<div class="row">
			 <div class="col-lg-12">
			 <div class="card">
                        ...
                        <a class="waves-effect waves-light btn" href='javascript:document.form1.submit();'>添加密码</a>
                        </form>
