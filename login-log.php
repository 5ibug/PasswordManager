            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        用户 <?php echo $user->username; ?>登录日志
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $logcon=$log->Read_A_User_Login($mysql,$user->username);

                                        for($i = 0; $i < sizeof($logcon); $i++){
                                            echo "  <tr>
                                                        <td class=\"center\">".($i + 1)."</td>
                                                        <td class=\"center\">".$logcon[$i]['user']."</td>
                                                        <td class=\"center\">".$logcon[$i]['message']."</td>
                                                        <td class=\"center\">".$logcon[$i]['ip']."</td>
                                                        <td class=\"center\">".date("Y-m-d h:i:s", $logcon[$i]['time'])."</td>
                                                    </tr>";
                                        }
                                        ?>
